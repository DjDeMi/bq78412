...
class AdvancedWindow(Gtk.Window):
    ...
    def on_design_capacity_button_clicked(self, button):
        ...
        while True:
            ...
            print(value)
            if(value != None):
                if(0<int(value,10)<3271):
                    print("Balio zuzena, ez da None")
                    break
                else:
                    print("Balio desegokia")
                    self.error_message("Data error", "Value must be between 1 to 3270. Try again.")
            else:
                print("None")
                self.error_message("Data error", "You need insert a value between 1 to 3270. Try again.")
        value = value.zfill(4)
        print(value)
